...
$data = array(
    1=> array(
        "Logo Perusahaan" => "<img src = '1.jpg' width ='100' height = '80'>",  
    ...
    2 => array(
        "Logo Perusahaan" => "<img src = '2.png' width ='100' height = '80'>",  
    ...
    3 => array(
        "Logo Perusahaan" => "<img src = '3.jpg' width ='100' height = '80'>",  
    ...
    4 => array(
        "Logo Perusahaan" => "<img src = '4.jpg' width ='100' height = '80'>",  
    ...
    5 => array(
        "Logo Perusahaan" => "<img src = '5.jpg' width ='100' height = '80'>",  
    ...
    6 => array(
        "Logo Perusahaan" => "<img src = '6.jpg' width ='100' height = '80'>",  
    ...
    7 => array(
        "Logo Perusahaan" => "<img src = '7.png' width ='100' height = '80'>",  
    ...
    8 => array(
        "Logo Perusahaan" => "<img src = '8.jpg' width ='100' height = '80'>",  
    ...
    9 => array(
        "Logo Perusahaan" => "<img src = '9.jpg' width ='100' height = '80'>",  
    ...
    10 => array(
        "Logo Perusahaan" => "<img src = '10.jpg' width ='100' height = '80'>",  
...
<b>Nama : Muhammad Ridho</b>
</br>
<b>NIM : 701220239</b>
</br>
<b> NRP %5 = 239% * 5 = 11,95 => Perusahaan teknologi </b>
    <?php
